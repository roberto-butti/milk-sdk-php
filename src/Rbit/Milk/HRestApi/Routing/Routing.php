...
namespace Rbit\Milk\HRestApi\Routing;
...
class Routing extends ApiClient
{
     ...
     */
    private string $paramModeTransport;



    private ?LatLong $paramWaypoint0 = null;
    private ?LatLong $paramWaypoint1 = null;
